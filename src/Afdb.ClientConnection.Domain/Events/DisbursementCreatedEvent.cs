...
public sealed class DisbursementCreatedEvent : DomainEvent
{
    ...
    public DisbursementCreatedEvent(Guid disbursementId, string requestNumber, string sapCodeProject, string loanGrantNumber)
    {
