    ...
    public static DisbursementEntity MapDisbursementToEntity(Disbursement disbursement)
    {
        ...
        if (disbursement.DisbursementA1 != null)
        {
            entity.DisbursementA1 = new DisbursementA1Entity
            {
                ...
                BeneficiaryBankName = disbursement.DisbursementA1.BeneficiaryBankName,
                BeneficiaryBankAddress = disbursement.DisbursementA1.BeneficiaryBankAddress,
                BeneficiaryAccountNumber = disbursement.DisbursementA1.BeneficiaryAccountNumber,
                BeneficiarySwiftCode = disbursement.DisbursementA1.BeneficiarySwiftCode,
        ...
        if (disbursement.DisbursementA2 != null)
        {
            entity.DisbursementA2 = new DisbursementA2Entity
            {
                ...
                ClaimantName = disbursement.DisbursementA2.ClaimantName,
                ClaimantAddress = disbursement.DisbursementA2.ClaimantAddress,
                ClaimantBankName = disbursement.DisbursementA2.ClaimantBankName,
        ...
        if (disbursement.DisbursementA3 != null)
        {
            entity.DisbursementA3 = new DisbursementA3Entity
            {
                ...
                RecipientName = disbursement.DisbursementA3.RecipientName,
                RecipientAddress = disbursement.DisbursementA3.RecipientAddress,
                RecipientBankName = disbursement.DisbursementA3.RecipientBankName,
        ...
        if (disbursement.DisbursementB1 != null)
        {
            entity.DisbursementB1 = new DisbursementB1Entity
            {
                ...
                DisbursementId = disbursement.Id,
                GuaranteePurpose = disbursement.DisbursementB1.GuaranteePurpose,
                BeneficiaryName = disbursement.DisbursementB1.BeneficiaryName,
                BeneficiaryAddress = disbursement.DisbursementB1.BeneficiaryAddress,
                ...
                CurrencyCode = disbursement.DisbursementB1.GuaranteeAmount.Currency,
        ...
        if (disbursement.Processes.Count > 0)
        {
            ...
            foreach (var process in newProcesses)
            {
                entity.Processes.Add(new DisbursementProcessEntity
                {
                    ...
                    ProcessedByUserId = process.ProcessedByUserId,
