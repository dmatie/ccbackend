...
namespace Afdb.ClientConnection.Infrastructure.Migrations
{
    ...
    [Migration("20251214043533_AddOtherDocumentTables")]
    partial class AddOtherDocumentTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Afdb.ClientConnection.Infrastructure.Data.Entities.AccessRequestDocumentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AccessRequestDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OtherDocumentTypeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OtherDocumentTypeId");

                    b.HasIndex("UserId");

                    b.ToTable("OtherDocuments", (string)null);
                });

            modelBuilder.Entity("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentFileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OtherDocumentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OtherDocumentFiles", (string)null);
                });

            modelBuilder.Entity("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentTypeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OtherDocumentTypes", (string)null);

                    b.HasData(
                        new
                        {
                            Id = new Guid("eae933da-22e9-4735-96c4-4483157bb27f"),
                        ...
                        new
                        {
                            Id = new Guid("25364bf0-87ae-4a5e-9897-c1eb5351ad5f"),
                            CreatedAt = new DateTime(2025, 12, 14, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatedBy = "System",
                            IsActive = true,
                            Name = "Other",
            ...
            modelBuilder.Entity("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentEntity", b =>
                {
                    b.HasOne("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentTypeEntity", "OtherDocumentType")
                        .WithMany("OtherDocuments")
                        .HasForeignKey("OtherDocumentTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("OtherDocumentType");
            ...
            modelBuilder.Entity("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentFileEntity", b =>
                {
                    b.HasOne("Afdb.ClientConnection.Infrastructure.Data.Entities.OtherDocumentEntity", "OtherDocument")
                        .WithMany("Files")
