...
public sealed class CreateDisbursementA1CommandValidator : AbstractValidator<CreateDisbursementA1Command?>
{
    public CreateDisbursementA1CommandValidator(IInputSanitizationService sanitizationService)
    {
