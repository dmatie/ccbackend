...
public sealed class EditDisbursementA1CommandValidator : AbstractValidator<EditDisbursementA1Command?>
{
    public EditDisbursementA1CommandValidator(IInputSanitizationService sanitizationService)
    {
        RuleFor(x => x)
           .Must(x => x != null)
           .WithMessage("ERR.Disbursement.A1.CommandCannotBeNull");

        RuleFor(x => x!.PaymentPurpose)
            .NotEmpty()
            .WithMessage("ERR.Disbursement.A1.PaymentPurposeEmpty")
            .MaximumLength(1500)
            .WithMessage("ERR.Disbursement.A1.PaymentPurposeMaxLength")
        ...
        RuleFor(x => x!.BeneficiaryBpNumber)
            ...
            .MaximumLength(50)
            .WithMessage("ERR.Disbursement.A1.BeneficiaryBpNumberMaxLength")
        ...
        RuleFor(x => x!.BeneficiaryName)
            ...
            .MaximumLength(200)
            .WithMessage("ERR.Disbursement.A1.BeneficiaryNameMaxLength")
        ...
        RuleFor(x => x!.BeneficiaryContactPerson)
            ...
            .MaximumLength(200)
            .WithMessage("ERR.Disbursement.A1.BeneficiaryContactPersonMaxLength")
            .SafeName(sanitizationService);
        ...
        RuleFor(x => x!.BeneficiaryAddress)
            ...
            .MaximumLength(500)
            .WithMessage("ERR.Disbursement.A1.BeneficiaryAddressMaxLength")
            .SafeDescription(sanitizationService);
        ...
        RuleFor(x => x!.BeneficiaryEmail)
            ...
            .MaximumLength(255)
            .WithMessage("ERR.Disbursement.A1.BeneficiaryEmailMaxLength");

        RuleFor(x => x!.CorrespondentBankName)
            .NotEmpty()
            .WithMessage("ERR.Disbursement.A1.CorrespondentBankNameRequired")
            .MaximumLength(200)
            .WithMessage("ERR.Disbursement.A1.CorrespondentBankNameMaxLength")
            .SafeName(sanitizationService);
        ...
        RuleFor(x => x!.CorrespondentBankAddress)
            ...
            .MaximumLength(500)
            .WithMessage("ERR.Disbursement.A1.CorrespondentBankAddressMaxLength")
            .SafeDescription(sanitizationService);
        ...
        RuleFor(x => x!.CorrespondantAccountNumber)
            ...
            .MaximumLength(100)
            .WithMessage("ERR.Disbursement.A1.CorrespondantAccountNumberMaxLength")
            .AlphanumericWithSpaces(allowDashes: true);
        ...
        RuleFor(x => x!.CorrespondentBankSwiftCode)
            ...
            .MaximumLength(11)
            .WithMessage("ERR.Disbursement.A1.CorrespondentBankSwiftCodeMaxLength")
        ...
        RuleFor(x => x!.SignatoryName)
            ...
            .MaximumLength(200)
            .WithMessage("ERR.Disbursement.A1.SignatoryNameMaxLength")
            .SafeName(sanitizationService);
        ...
        RuleFor(x => x!.SignatoryContactPerson)
            ...
            .MaximumLength(200)
            .WithMessage("ERR.Disbursement.A1.SignatoryContactPersonMaxLength")
            .SafeName(sanitizationService);
        ...
        RuleFor(x => x!.SignatoryAddress)
            ...
            .MaximumLength(500)
            .WithMessage("ERR.Disbursement.A1.SignatoryAddressMaxLength")
            .SafeDescription(sanitizationService);
        ...
        RuleFor(x => x!.SignatoryEmail)
            ...
            .MaximumLength(255)
            .WithMessage("ERR.Disbursement.A1.SignatoryEmailMaxLength");

        RuleFor(x => x!.SignatoryPhone)
            .NotEmpty()
            .WithMessage("ERR.Disbursement.A1.SignatoryPhoneRequired")
            .MaximumLength(50)
            .WithMessage("ERR.Disbursement.A1.SignatoryPhoneMaxLength")
            .Matches(@"^[\d\s\+\-\(\)]+$")
        ...
        RuleFor(x => x!.SignatoryTitle)
            ...
            .MaximumLength(100)
            .WithMessage("ERR.Disbursement.A1.SignatoryTitleMaxLength")
            .SafeName(sanitizationService);
    }
}
