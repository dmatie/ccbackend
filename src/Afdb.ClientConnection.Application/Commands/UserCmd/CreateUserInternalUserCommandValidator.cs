...
public sealed class CreateUserInternalUserCommandValidator : AbstractValidator<CreateUserInternalUserCommand>
{
    public CreateUserInternalUserCommandValidator()
    {
        RuleFor(x => x.Email)
            .NotEmpty()
