...
public class UpdateRejecyedAccessRequestCommandValidatorTests
{
    private readonly UpdateRejectedAccessRequestCommandValidator _validator;

    public UpdateRejecyedAccessRequestCommandValidatorTests()
    {
        _validator = new UpdateRejectedAccessRequestCommandValidator();
    }
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { Email = "" };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { Email = "invalid-email" };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { Email = new string('a', 250) + "@test.com" };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { FirstName = "" };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { FirstName = new string('a', 101) };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { LastName = "" };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand { LastName = new string('a', 101) };
    ...
    {
        // Arrange
        var command = new UpdateRejectedAccessRequestCommand
        {
